									...
									<div class="slide">
										<div class="five columns alpha">
											<div class="content">
												...
												<div class="bucket-follow"><a class="primary btn" href="<?php bloginfo('home');?>/weblog/entry/27742">Read the Book</a></div>
											</div> <!--! end of "content" -->
										</div> <!--! end of "five columns alpha" -->
										<div class="eleven columns omega">
											<div class="film">
											<a href="<?php bloginfo('home');?>/weblog/entry/27742"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/poo.jpg" alt="The Power of Open" /></a>
												<div class="caption">
													<p>The Power of Open: Stories of creators sharing knowledge, art, & data using Creative Commons. <a href="<?php bloginfo('home');?>/weblog/entry/27742">Read it now</a>.</p>
												</div>
											</div><!--! end of "film" -->
										</div><!--! end of "eleven columns omega" -->
									</div> <!--! end of "slide" -->
